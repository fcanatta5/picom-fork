...
static bool win_script_preset__scale_template(struct win_script *output,
...
static bool win_script_preset__zoom_in(struct win_script *output,
                                       config_setting_t *setting) {
	return win_script_preset__scale_template(output, setting, true, 0.16, 0.88);
}

static bool win_script_preset__zoom_out(struct win_script *output,
                                        config_setting_t *setting) {
	return win_script_preset__scale_template(output, setting, false, 0.13, 0.88);
}

static bool win_script_preset__pop_in(struct win_script *output,
                                      config_setting_t *setting) {
	return win_script_preset__scale_template(output, setting, true, 0.20, 0.82);
}

static bool win_script_preset__pop_out(struct win_script *output,
                                       config_setting_t *setting) {
	return win_script_preset__scale_template(output, setting, false, 0.14, 0.86);
}

static bool win_script_preset__slide_fixed(struct win_script *output,
                                           config_setting_t *setting,
                                           bool slide_in,
                                           double placeholder1,
                                           double placeholder2,
...
static bool win_script_preset__slide_up_in(struct win_script *output,
                                           config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, true, 0, -1, 0);
}
static bool win_script_preset__slide_up_out(struct win_script *output,
                                            config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, false, 0, -1, 0);
}
static bool win_script_preset__slide_down_in(struct win_script *output,
                                             config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, true, 0, 1, 0);
}
static bool win_script_preset__slide_down_out(struct win_script *output,
                                              config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, false, 0, 1, 0);
}
static bool win_script_preset__slide_left_in(struct win_script *output,
                                             config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, true, -1, 0, 1);
}
static bool win_script_preset__slide_left_out(struct win_script *output,
                                              config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, false, -1, 0, 1);
}
static bool win_script_preset__slide_right_in(struct win_script *output,
                                              config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, true, 1, 0, 1);
}
static bool win_script_preset__slide_right_out(struct win_script *output,
                                               config_setting_t *setting) {
	return win_script_preset__slide_fixed(output, setting, false, 1, 0, 1);
}

static bool win_script_preset__fly_fixed(struct win_script *output,
                                         config_setting_t *setting,
                                         bool fly_in,
                                         double placeholder1,
                                         double placeholder2,
...
static bool win_script_preset__fly_up_in(struct win_script *output,
                                         config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, true, 0, -1, 0, 0, -1);
}
static bool win_script_preset__fly_up_out(struct win_script *output,
                                          config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, false, 0, -1, 0, 0, -1);
}
static bool win_script_preset__fly_down_in(struct win_script *output,
                                           config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, true, 0, 1, 0, 0, 0);
}
static bool win_script_preset__fly_down_out(struct win_script *output,
                                            config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, false, 0, 1, 0, 0, 0);
}
static bool win_script_preset__fly_left_in(struct win_script *output,
                                           config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, true, -1, 0, 1, -1, 0);
}
static bool win_script_preset__fly_left_out(struct win_script *output,
                                            config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, false, -1, 0, 1, -1, 0);
}
static bool win_script_preset__fly_right_in(struct win_script *output,
                                            config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, true, 1, 0, 1, 0, 0);
}
static bool win_script_preset__fly_right_out(struct win_script *output,
                                             config_setting_t *setting) {
	return win_script_preset__fly_fixed(output, setting, false, 1, 0, 1, 0, 0);
}
...
static bool win_script_preset__geometry_fast(struct win_script *output,
                                             config_setting_t *setting) {
	return win_script_preset__geometry_template(output, setting, 0.16);
}

static bool win_script_preset__geometry_smooth(struct win_script *output,
                                               config_setting_t *setting) {
	return win_script_preset__geometry_template(output, setting, 0.28);
}

static bool win_script_preset__move_smooth(struct win_script *output,
                                           config_setting_t *setting) {
...
struct {
    ...
    {"zoom-in", win_script_preset__zoom_in},
    {"zoom-out", win_script_preset__zoom_out},
    {"pop-in", win_script_preset__pop_in},
    {"pop-out", win_script_preset__pop_out},
    {"slide-up-in", win_script_preset__slide_up_in},
    {"slide-up-out", win_script_preset__slide_up_out},
    {"slide-down-in", win_script_preset__slide_down_in},
    {"slide-down-out", win_script_preset__slide_down_out},
    {"slide-left-in", win_script_preset__slide_left_in},
    {"slide-left-out", win_script_preset__slide_left_out},
    {"slide-right-in", win_script_preset__slide_right_in},
    {"slide-right-out", win_script_preset__slide_right_out},
    {"fly-up-in", win_script_preset__fly_up_in},
    {"fly-up-out", win_script_preset__fly_up_out},
    {"fly-down-in", win_script_preset__fly_down_in},
    {"fly-down-out", win_script_preset__fly_down_out},
    {"fly-left-in", win_script_preset__fly_left_in},
    {"fly-left-out", win_script_preset__fly_left_out},
    {"fly-right-in", win_script_preset__fly_right_in},
    {"fly-right-out", win_script_preset__fly_right_out},
    {"geometry-fast", win_script_preset__geometry_fast},
    {"geometry-smooth", win_script_preset__geometry_smooth},
    {"move-smooth", win_script_preset__move_smooth},
    {NULL, NULL},
};
