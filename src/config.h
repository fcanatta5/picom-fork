...
enum animation_trigger {
	...
	/// Reserved for backwards compatibility. Runtime emits size/position changes;
	/// the user-facing "geometry" trigger is parsed as an alias below.
	...
	/// User-facing alias of size + position
